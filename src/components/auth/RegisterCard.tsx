      ...
      <div className="bg-cyber-surface/80 relative rounded-[2.5rem] border border-white/5 p-8 shadow-[0_0_50px_-12px_rgba(139,92,246,0.3)] ring-1 ring-white/10 backdrop-blur-xl md:p-12">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <div className="group relative">
              ...
              <Input
                ...
                className={`focus:border-cyber-blue/50 focus:ring-cyber-blue/10 selection:bg-cyber-blue/30 h-13 rounded-2xl border-white/5 bg-white/3 pl-12 text-base text-white transition-all placeholder:text-white/10 focus:ring-4 ${errors.name ? "border-red-500/50 ring-red-500/10 focus:border-red-500/50 focus:ring-red-500/10" : ""}`}
              />
            </div>
            {errors.name && (
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input
                ...
                className={`focus:border-cyber-blue/50 focus:ring-cyber-blue/10 selection:bg-cyber-blue/30 h-13 rounded-2xl border-white/5 bg-white/3 text-base text-white transition-all placeholder:text-white/10 focus:ring-4 ${errors.password ? "border-red-500/50 ring-red-500/10 focus:border-red-500/50 focus:ring-red-500/10" : ""}`}
              />
              {errors.password && (
                <p className="mt-1 ml-1 text-[10px] font-bold text-red-400/80">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className={`focus:border-cyber-blue/50 focus:ring-cyber-blue/10 selection:bg-cyber-blue/30 h-13 rounded-2xl border-white/5 bg-white/3 text-base text-white transition-all placeholder:text-white/10 focus:ring-4 ${errors.confirmPassword ? "border-red-500/50 ring-red-500/10 focus:border-red-500/50 focus:ring-red-500/10" : ""}`}
              />
          ...
          <Button
            type="submit"
            disabled={isLoading}
            className="group bg-cyber-gradient shadow-cyber-purple/20 relative mt-4 h-14 w-full overflow-hidden rounded-2xl text-lg font-bold text-white shadow-lg transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-70"
          >
            {isLoading ? (
